...
namespace Racecar_Tracker_By_UherkaMotorsports.Controllers
{
    public class CrewsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nights,Tires,Springs")] Crew crew)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nights,Tires,Springs")] Crew crew)
        {
            if (id != crew.Id)
            {
                return NotFound();
